...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-1 page-title">Master Aset</h1>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-4">
            <form action="<?= base_url('aset-komersial') ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="card h-100 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="nama_aset" class="form-label">Nama Barang / Aset <span class="text-danger">*</span></label>
                                    <input type="text" name="nama_aset" id="nama_aset" class="form-control" placeholder="Contoh: Mesin Penggiling Kopi" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" name="tahun_perolehan" id="tahun_perolehan" class="form-control" placeholder="2024">
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="mb-0">
                                    ...
                                    <input type="text" name="keterangan" id="keterangan" class="form-control" placeholder="Contoh: Kondisi Baik">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    // Ambil elemen input file dan container preview
