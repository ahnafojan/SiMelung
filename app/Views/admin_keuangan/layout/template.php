...
<head>
    ...
    <link rel="stylesheet" href="/css/css-keuangan.css">
...
<body>
    ...
    <div id="wrapper">
        <?= $this->include('admin_keuangan/layout/sidebar'); ?>
        <div id="content-wrapper">
            <?= $this->include('admin_keuangan/layout/navbar'); ?>
            ...
            <?= $this->include('admin_keuangan/layout/footer'); ?>
        </div>
    </div>
