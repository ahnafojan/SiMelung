                            ...
                            <?php foreach ($pariwisata as $index => $p) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('bumdes/export/pariwisata/pdf?id=' . $p['id']) ?>" class="btn btn-sm btn-danger">
                                            <i class="fas fa-file-pdf"></i> Export PDF
                                        </a>
                                        <a href="<?= base_url('bumdes/export/pariwisata/excel?id=' . $p['id']) ?>" class="btn btn-sm btn-success">
