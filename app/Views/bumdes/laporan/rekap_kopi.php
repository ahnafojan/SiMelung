...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const perPageMasuk = document.getElementById('per_page_masuk');
        if (perPageMasuk) {
            perPageMasuk.addEventListener('change', function() {
                document.getElementById('perPageFormMasuk').submit();
            });
        }

        const perPageKeluar = document.getElementById('per_page_keluar');
        if (perPageKeluar) {
            perPageKeluar.addEventListener('change', function() {
                document.getElementById('perPageFormKeluar').submit();
            });
        }

        const perPageStok = document.getElementById('per_page_stok');
        if (perPageStok) {
            perPageStok.addEventListener('change', function() {
                document.getElementById('perPageFormStok').submit();
            });
        }
    });
</script>
