...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <!-- TOMBOL EKSPOR DIHAPUS DARI SINI -->
        ...
        <div class="card-body">
                    ...
                    <form id="filterAsetForm">
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-2 col-md-12 mb-3">
                                <!-- URL disesuaikan ke rute desa -->
                                <a href="<?= base_url('DesaRekapAset') ?>" class="btn btn-outline-secondary btn-sm d-block">
            ...
            <div id="aset-data-container">
                <!-- Partial view untuk tabel akan dimuat di sini oleh AJAX -->
                <!-- Anda perlu memastikan partial view ini ada dan path-nya benar -->
                <?= $this->include('desa/laporan_komersial/_aset_table_partial', ['aset' => $aset, 'pagerAset' => $pagerAset]) ?>
            </div>
        </div>
    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // URL AJAX disesuaikan ke rute desa
        const baseUrl = "<?= site_url('desa/laporan_komersial/aset') ?>";
