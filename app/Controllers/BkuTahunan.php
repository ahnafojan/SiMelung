...
class BkuTahunan extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('admin_keuangan/bku_tahunan/index', $data);
    }
    ...
    public function cetakPdf($tahun = null)
    {
        ...
        // =======================================================================================
        $this->logAktivitas('CETAK PDF TAHUNAN', "Mencetak laporan BKU Tahunan (PDF) untuk periode {$tahun}");
        ...
        $html = view('admin_keuangan/bku_tahunan/cetak_pdf', $data);
    ...
    public function cetakExcel($tahun = null)
    {
        ...
        $this->logAktivitas('CETAK EXCEL TAHUNAN', "Mencetak laporan BKU Tahunan (Excel) untuk periode {$tahun}");
