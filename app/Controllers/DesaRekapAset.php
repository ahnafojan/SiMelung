 ...
 */
class DesaRekapAset extends BaseController
{
    use ResponseTrait;
    ...
    public function index()
    {
        ...
        // PERBAIKAN: Selalu gunakan instance baru untuk memulai query yang bersih
        $asetModelBuilder = new AsetKomersialModel();
        ...
        // Pager sekarang diambil dari instance yang baru
        $pagerAset = $asetModelBuilder->pager;
        ...
        if ($this->request->isAJAX()) {
            ...
            // Mengarah ke partial view DESA
            $table_partial = view('desa/laporan_komersial/_aset_table_partial', [
                'aset'      => $dataAset,
                'pagerAset' => $pagerAset
            ]);
