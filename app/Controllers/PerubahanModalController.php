...
class PerubahanModalController extends BaseController
{
    ...
    public function simpan()
    {
        ...
        $this->logAktivitas('Simpan Perubahan Modal', "Pengguna menyimpan/memperbarui data Laporan Perubahan Modal untuk tahun {$tahun}.");
    ...
    public function exportExcel($tahun)
    {
        ...
        $this->logAktivitas('CETAK EXCEL', "Mencetak laporan Perubahan Modal (Excel) untuk periode {$data['tahun']}");
        // Output
