...
class BkuBulanan extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('admin_keuangan/bku_bulanan/index', $data);
    }
    ...
    public function detail($id = null)
    {
        ...
        return view('admin_keuangan/bku_bulanan/detail', $data);
    }
    /**
    ...
    public function new()
    {
        ...
        return view('admin_keuangan/bku_bulanan/new', $data);
    }
    ...
    public function edit($id = null)
    {
        ...
        return view('admin_keuangan/bku_bulanan/edit', $data);
    }
