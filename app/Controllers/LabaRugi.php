...
class LabaRugi extends BaseController
{
    public function index()
    {
        ...
        return view('admin_keuangan/laba_rugi/index', $data);
    }
    ...
    public function simpan()
    {
        ...
        // 3. Redirect
        $this->logAktivitas('Simpan Laba Rugi', "Pengguna menyimpan/memperbarui data Laporan Laba Rugi untuk tahun {$tahun}.");
    ...
    public function cetakExcel($tahun = null)
    {
        ...
        $this->logAktivitas('Cetak Excel Laba Rugi', "Pengguna mencetak Laporan Laba Rugi dalam format Excel untuk tahun {$tahun}.");
        $data = $this->getLaporanLabaRugiData($tahun);
